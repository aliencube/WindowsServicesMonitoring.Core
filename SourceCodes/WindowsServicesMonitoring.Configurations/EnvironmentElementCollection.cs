...
{
    /// <summary>
    /// This represents the environment element collection entity.
    /// </summary>
    public class EnvironmentElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (EnvironmentElement)this.BaseGet(index); }
            set
            {
        ...
        {
            get { return (EnvironmentElement)this.BaseGet(key); }
            set
            {
                var item = (EnvironmentElement)this.BaseGet(key);
                if (item != null)
                {
