...
{
    /// <summary>
    /// This represents the service element collection entity.
    /// </summary>
    public class ServiceElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (ServiceElement)this.BaseGet(index); }
            set
            {
        ...
        {
            get { return (ServiceElement)this.BaseGet(key); }
            set
            {
                var item = (ServiceElement)this.BaseGet(key);
                if (item != null)
                {
